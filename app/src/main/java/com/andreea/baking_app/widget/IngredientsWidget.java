...
public class IngredientsWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        String recipe = IngredientsWidgetConfigureActivity.loadRecipePref(context, appWidgetId);
        String ingredients = IngredientsWidgetConfigureActivity.loadIngredientsPref(context, appWidgetId, recipe);
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            String recipe = IngredientsWidgetConfigureActivity.loadRecipePref(context, appWidgetId);
            IngredientsWidgetConfigureActivity.deleteIngredientsPref(context, appWidgetId, recipe);
